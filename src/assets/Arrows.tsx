...
export const ArrowLeft: React.FC<ArrowProps> = ({ size, className }) => {
...
export const ArrowRight: React.FC<ArrowProps> = ({ size, className: color }) => {
    return <svg className={color} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
